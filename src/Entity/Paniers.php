 ...
 * Paniers
 *
 * @ORM\Table(name="paniers", indexes={@ORM\Index(name="sk_nom", columns={"nomProduit"}), @ORM\Index(name="sk_user", columns={"numeroUtilisateur"}), @ORM\Index(name="sk_produit", columns={"numeroProduit"})})
 * @ORM\Entity
 */
class Paniers
{
