...
class CommentairesController extends AbstractController
{
     ...
     */
    public function new(Request $request, CommentairesRepository $commentairesRepository, FlashyNotifier $flashy,$id,UtilisateursRepository $utilisateursRepository): Response
    {
        $commentaire = new Commentaires();
        $user=$utilisateursRepository->find($id);
        $form = $this->createForm(CommentairesType::class, $commentaire);
        $commentaire->setNumeroutilisateur($user);
